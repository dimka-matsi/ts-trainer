...
const CONCEPTS: { name: string; re: RegExp; at: string }[] = [
  ...
  { name: "OCSP", re: /\bOCSP\b|\bCRL\b|CRLite|\bACME\b/, at: "tls6" },
  { name: "Range-запросы", re: /Content-Range|Accept-Ranges/i, at: "http8" },
  { name: "Service Worker", re: /Service Worker|Cache API/, at: "cache7" },
  { name: "Page Lifecycle", re: /visibilitychange|Page Lifecycle/, at: "br4" },
  { name: "Web Push", re: /VAPID|push-сервис/i, at: "rt5" },
  ...
  { name: "SSRF", re: /\bSSRF\b|SQL-инъекц/, at: "sec9" },
  { name: "prototype pollution", re: /prototype pollution|__proto__/i, at: "sec10" },
  { name: "postMessage и sandbox", re: /postMessage|allow-scripts|allow-same-origin/, at: "sec11" },
  { name: "Trusted Types", re: /Trusted Types|require-trusted-types|TrustedHTML/, at: "sec12" },
  { name: "хэши паролей", re: /Argon2|bcrypt|scrypt|радужн/i, at: "ck8" },
  { name: "passkeys", re: /passkey|WebAuthn|FIDO|\bTOTP\b/i, at: "ck9" },
  { name: "IDOR", re: /\bIDOR\b/, at: "ck10" },
  { name: "лимит запросов", re: /rate limit|Too Many Requests|Retry-After/i, at: "up3" },
  ...
  { name: "Speculation Rules", re: /speculationrules|Speculation Rules|prerender/i, at: "perf9" },
  { name: "полифилы и browserslist", re: /browserslist|core-js|useBuiltIns/i, at: "bnd4" },
  { name: "edge-функции", re: /edge-функц|Edge Functions|Workers/i, at: "srv6" },
  { name: "резерв места", re: /aspect-ratio|size-adjust/i, at: "ui7" },
  ...
  { name: "ререндер", re: /(?<!п)ререндер/i, at: "rx1" },
  ...
  // JavaScript
  { name: "поднятие и TDZ", re: /подняти|hoisting|\bTDZ\b|мёртв\S* зон/i, at: "scp2" },
  { name: "замыкание", re: /замыкани|closure/i, at: "scp3" },
  { name: "IIFE", re: /\bIIFE\b/, at: "scp5" },
  { name: "this", re: /\bthis\b/, at: "fun2" },
  { name: "call, apply, bind", re: /\.(call|apply|bind)\(|`(call|apply|bind)`/, at: "fun2" },
  { name: "каррирование", re: /карриров|\bcurry/i, at: "fun5" },
  { name: "прототип", re: /прототип|prototype|__proto__|Object\.create/i, at: "obj2" },
  { name: "классы", re: /\bclass [A-Z]|\bextends\b|\bsuper\b/, at: "obj4" },
  ...
  { name: "комбинаторы промисов", re: /Promise\.(all|allSettled|race|any)\b/, at: "asy5" },
  { name: "DOM в JavaScript", re: /\bDOM\b|\bdocument\./, at: "dom1" },
  { name: "всплытие событий", re: /всплыти|всплыва|bubbl|погружени|stopPropagation/i, at: "dom2" },
  { name: "делегирование", re: /делегировани/i, at: "dom3" },
  { name: "опции обработчика", re: /\bpassive\b/, at: "dom4" },
  { name: "AbortController", re: /AbortController|AbortSignal/, at: "dom4" },
  { name: "загрузка страницы", re: /DOMContentLoaded|\bdefer\b/, at: "dom5" },
  { name: "fetch", re: /\bfetch\b/, at: "wa1" },
  { name: "хранилища", re: /localStorage|sessionStorage|IndexedDB/, at: "wa2" },
  { name: "requestAnimationFrame", re: /requestAnimationFrame/, at: "wa3" },
  { name: "observers", re: /IntersectionObserver|ResizeObserver|MutationObserver/, at: "wa4" },
