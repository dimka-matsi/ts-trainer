 ...
 */
const REGION_LESSONS: WebLesson[][] = [metrics, network, server, ui, engine];
...
const REGIONS: WebRegion[] = [
  ...
  { name: "Сеть и загрузка", kind: "lessons", desc: "Меньше байтов и кругов туда-обратно: сжатие, подсказки браузеру, картинки, ленивая загрузка, бандл, сторонние скрипты." },
...
const EXTRA_CARDS: Flashcard[] = [
  ...
  {
    id: "opt-memo", region: 3, level: "middle",
