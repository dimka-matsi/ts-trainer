...
export const LESSONS: Lesson[] = [...BASICS_LESSONS, ...NARROWING_LESSONS, ...FUNCTIONS_LESSONS, ...OBJECTS_LESSONS, ...GENERICS_LESSONS, ...UTILITIES_LESSONS, ...CONDITIONAL_LESSONS, ...CONTRACTS_LESSONS];
