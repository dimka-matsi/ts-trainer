...
export interface QuizTask {
  ...
  code?: string;
  /**
   * Вопрос «что выведет»: варианты — вывод `console.log` кода `code`, строки через перевод строки.
   * verify выполняет код и проверяет, что верный вариант совпадает с настоящим выводом, а остальные — нет.
   */
  output?: boolean;
