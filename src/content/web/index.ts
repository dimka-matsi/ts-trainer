...
const REGIONS: WebRegion[] = [
  ...
  { name: "HTTP", kind: "lessons", desc: "Запрос и ответ, методы, коды, заголовки, cookies, соединения, стили API, версии протокола, загрузка файлов и Range-запросы." },
  { name: "HTTPS и TLS", kind: "lessons", desc: "Зачем HTTPS, шифрование, сертификаты, рукопожатие TLS 1.3, HSTS, отзыв сертификатов и короткие сроки." },
  { name: "Кэширование", kind: "lessons", desc: "HTTP-кэш браузера и общие кэши: свежесть, проверка и 304, файлы с хэшем, Vary, bfcache, Service Worker и Cache API." },
  ...
  { name: "Устройство браузера", kind: "lessons", desc: "Из каких процессов состоит браузер, как он изолирует сайты, чем отличаются движки и что происходит с вкладкой в фоне." },
  ...
  { name: "Реальное время", kind: "lessons", desc: "Как сервер отправляет данные сам: polling, Server-Sent Events, WebSocket, WebRTC, push-уведомления." },
];
