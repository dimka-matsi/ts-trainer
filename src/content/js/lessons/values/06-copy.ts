...
export const lesson: WebLesson = {
  ...
  theory: {
    p: [
      ...
      "Глубокая копия копирует все уровни. Встроенный способ — `structuredClone(obj)`: он есть в браузерах и Node.js, копирует даты, массивы, вложенные объекты и циклические ссылки. Функции он не копирует — бросает ошибку.",
...
console.log(copy.ratio);`,
    ...
    },
    {
      ...
      a: 0,
      why: "`structuredClone` копирует только данные. На функции и других некопируемых значениях он бросает `DataCloneError`.",
    },
    {
      type: "run",
