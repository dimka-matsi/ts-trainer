...
export function HubView() {
  ...
  const tracks: TrackCard[] = [
    ...
    {
      id: "web", name: "Браузер", tagline: "События, HTTP, сеть, рендеринг",
      about: "Как устроен браузер: события DOM, event loop, HTTP и кэш, CORS, безопасность. Код выполняется в настоящем DOM.",
    ...
    { id: "js", name: "JavaScript", tagline: "Замыкания, this, прототипы, асинхронность", about: "Язык без типов: то, на чём держится всё остальное." },
